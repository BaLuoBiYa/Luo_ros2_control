...
namespace legged {
    ...
    KalmanFilterEstimate::KalmanFilterEstimate(ocs2::PinocchioInterface pinocchioInterface,
        ...
        c1 << ocs2::legged_robot::matrix3_t::Identity(), ocs2::legged_robot::matrix3_t::Zero();
        c2 << ocs2::legged_robot::matrix3_t::Zero(), ocs2::legged_robot::matrix3_t::Identity();
        ...
        sub_ = node->create_subscription<nav_msgs::msg::Odometry>(
            "/tracking_camera/odom/sample", rclcpp::QoS(10),
    ...
    ocs2::vector_t KalmanFilterEstimate::update(const rclcpp::Time &time, const rclcpp::Duration &period) {
        ...
        q_.block(0, 0, 3, 3) = (dt / 20.f) * ocs2::legged_robot::matrix3_t::Identity();
        q_.block(3, 3, 3, 3) = (dt * 9.81f / 20.f) * ocs2::legged_robot::matrix3_t::Identity();
        ...
        ocs2::legged_robot::vector3_t g(0, 0, -9.81);
        ocs2::legged_robot::vector3_t accel =
            ocs2::getRotationMatrixFromZyxEulerAngles(quatToZyx(quat_)) * linearAccelLocal_ + g;
        ...
        nav_msgs::msg::Odometry odom = getOdomMsg();
    ...
    void KalmanFilterEstimate::updateFromTopic() {
        auto opt = buffer_.try_get();
        if (opt == std::nullopt) {
            return;
        }
        nav_msgs::msg::Odometry msg = opt.value();
        ...
        ocs2::legged_robot::vector3_t newPos(odom2base.getOrigin().x(), odom2base.getOrigin().y(),
    ...
    nav_msgs::msg::Odometry KalmanFilterEstimate::getOdomMsg() {
        ...
        ocs2::vector_t twist =
            ocs2::getRotationMatrixFromZyxEulerAngles(quatToZyx(quat_)).transpose() * xHat_.segment<3>(3);
