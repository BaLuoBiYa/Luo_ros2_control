...
namespace legged {
    ...
    class StateEstimateBase {
      public:
        StateEstimateBase(ocs2::PinocchioInterface pinocchioInterface, ocs2::CentroidalModelInfo info,
        ...
        virtual void updateContact(ocs2::legged_robot::contact_flag_t contactFlag) {
        ...
        size_t getMode() {
            return ocs2::legged_robot::stanceLeg2ModeNumber(contactFlag_);
        }
    ...
    template <typename SCALAR_T> Eigen::Matrix<SCALAR_T, 3, 1> quatToZyx(const Eigen::Quaternion<SCALAR_T> &q) {
